...
notebook_artifacts = filtered[~is_data_platform].copy()
data_platform_artifacts = filtered[is_data_platform].copy()

tab_notebook, tab_data_platform, tab_contract = st.tabs(["Notebook Artifacts", "Data Platform Artifacts", "Contract Freshness"])
