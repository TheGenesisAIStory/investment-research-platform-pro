...
from support import configure_page, dataframe_with_download, load_company_artifacts, load_portfolio_artifacts, numeric_cols, sidebar_roots
...
cols[3].metric("Preset", preset)

company_tab, portfolio_tab = st.tabs(["Company Screener", "Portfolio Selection"])
