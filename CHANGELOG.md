...
- Implemented experimental `cross_asset_value` and rolling PCA `global_risk_factor` in the existing cross-asset module.
- Implemented experimental `liquidity_factor` using Amihud (2002) illiquidity with a Roll-style spread-proxy fallback.
