...
FILTER_SCHEMA = {
    ...
    "internal": {
        ...
        "dcf_mispricing": {"type": "numeric", "operators": ["gt", "lt", "between", "top_pct"]},
        "dcf_probability_undervalued": {"type": "numeric", "operators": ["gt", "lt", "between", "top_pct"]},
        "dcf_scenario_spread": {"type": "numeric", "operators": ["gt", "lt", "between", "bottom_pct"]},
        "residual_income_mispricing": {"type": "numeric", "operators": ["gt", "lt", "between", "top_pct"]},
        "eva_value_gap": {"type": "numeric", "operators": ["gt", "lt", "between", "top_pct"]},
...
FIELD_ALIASES = {
    ...
    "dcf_mispricing": ["dcf_mispricing", "dcf_upside", "dcf_discount", "dcf_model_mispricing"],
    "dcf_probability_undervalued": ["dcf_probability_undervalued", "dcf_prob_undervalued", "probability_undervalued"],
    "dcf_scenario_spread": ["dcf_scenario_spread", "dcf_uncertainty", "dcf_fair_value_spread"],
    "residual_income_mispricing": ["residual_income_mispricing", "ri_mispricing", "residual_income_upside"],
    "eva_value_gap": ["eva_value_gap", "eva_mispricing", "eva_upside"],
}
...
SCREENER_PRESETS = {
    ...
    "DCF mispricing opportunities": {
        "description": "Names with DCF-implied upside, probability support and controlled scenario spread.",
        "filters": [
            {"field": "dcf_mispricing", "op": "gt", "value": 0.05},
            {"field": "dcf_probability_undervalued", "op": "gt", "value": 0.55},
        ],
        "ranking": {
            "mode": "weighted_score",
            "weights": {"dcf_mispricing": 0.45, "dcf_probability_undervalued": 0.30, "dcf_scenario_spread": 0.15, "quality_score": 0.10},
            "lower_is_better": {"dcf_scenario_spread": True},
        },
    },
}
...
DEFAULT_RESULT_COLUMNS = [
    ...
    "upside_to_fair_value", "dcf_mispricing", "dcf_probability_undervalued",
    "dcf_scenario_spread", "residual_income_mispricing", "eva_value_gap",
    "ml_prediction_score", "screener_score",
]
...
def build_screener_base_frame(namespace: Mapping[str, Any]) -> pd.DataFrame:
    ...
    for name in [
        "companyranking", "company_ranking", "valuationoutput", "valuation_output", "valuationoutput", "valuation_gap_table",
        "dcf_model_factors", "DCFModelBasedFactors", "residual_income_model_factors", "ResidualIncomeModelBasedFactors",
        "eva_model_factors", "EVAModelBasedFactors", "model_based_factors",
    ]:
