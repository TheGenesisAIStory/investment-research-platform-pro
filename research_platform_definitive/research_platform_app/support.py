...
def render_platform_sidebar() -> None:
    ...
    _safe_page_link("pages/15_📚_Academic_Reference.py", "Academic Reference")
...
def load_smart_money_artifacts(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "smart_money_asset_catalog": read_csv_any(smart_root, ["tables/SmartMoneyAssetCatalog.csv"]),
        "etf_flows_snapshot": read_csv_any(smart_root, ["etf_flows/etf_flows_snapshot.csv", "tables/SmartMoney_ETF_flows_snapshot.csv"]),
        "options_pcr_snapshot": read_csv_any(smart_root, ["options/pcr_snapshot.csv", "tables/SmartMoney_options_pcr_snapshot.csv"]),
