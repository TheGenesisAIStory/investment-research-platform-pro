...
FACTOR_BLOCKS: dict[str, FactorBlock] = {
    ...
    "eps_factors": FactorBlock(
        "eps_factors",
        "EPS & Earnings Factors",
        (
            "eps_surprise",
            "eps_revision",
            "eps_revision_3m",
        ...
        "Experimental earnings-surprise, analyst-revision and EPS valuation features with fiscal-period lag.",
        experimental=True,
    ),
    ...
    "cross_asset_value": FactorBlock(
        "cross_asset_value",
        "Cross-Asset Value",
        ("xasset_value_score",),
        "Experimental value-everywhere composite built from supplied equity, FX, FI and commodity value signals.",
        experimental=True,
    ),
    "global_risk_factor": FactorBlock(
        "global_risk_factor",
        "Global Risk Factor",
        ("global_risk_factor", "global_risk_explained_variance"),
...
FACTOR_REGISTRY: dict[str, dict[str, object]] = {
    ...
    "cross_asset_value": {
        "module": "research_platform_core.cross_asset_factors",
        "function": "cross_asset_value",
        "asset_class": "multi_asset",
        "category": "value",
        "frequency": "monthly",
        "experimental": True,
        "academic_reference": "Asness, Moskowitz and Pedersen (2013)",
        "data_requirements": ["equity_hml", "fx_ppp", "fi_yield_reversion", "commodity_value"],
        "anti_leakage": "shift(1), rolling z-score estimated from prior observations",
    },
    "global_risk_factor": {
        "module": "research_platform_core.cross_asset_factors",
        "function": "global_risk_factor",
        "asset_class": "multi_asset",
        "category": "risk",
        "frequency": "monthly",
        "experimental": True,
    ...
    "eps_factors": {
        ...
        "function": "build_eps_factors",
        "asset_class": "equity",
        "category": "earnings",
        "frequency": "quarterly",
        "experimental": True,
        "academic_reference": "Ball and Brown (1968); Bernard and Thomas (1989); Basu (1977)",
        "data_requirements": ["actual_eps", "consensus_eps or naive EPS proxy", "price"],
        "anti_leakage": "groupby(ticker).shift(1 fiscal period)",
    },
    "monte_carlo_returns": {
        "module": "simulation.monte_carlo",
        "function": "monte_carlo_returns",
        "asset_class": "portfolio",
        "category": "simulation",
        "frequency": "run_on_demand",
        "experimental": True,
        "academic_reference": "Glasserman (2003)",
        "data_requirements": ["factor_scores", "covariance estimated from historical factor returns"],
        "anti_leakage": "uses only supplied historical matrix; caller must provide PIT inputs",
    },
    "monte_carlo_factor_uncertainty": {
        "module": "simulation.monte_carlo",
        "function": "monte_carlo_factor_uncertainty",
        "asset_class": "model",
        "category": "simulation",
        "frequency": "run_on_demand",
        "experimental": True,
        "academic_reference": "Glasserman (2003); Jegadeesh and Titman style bootstrap validation",
        "data_requirements": ["factor_df"],
        "anti_leakage": "bootstrap over supplied in-sample factor matrix only",
    },
}
