...
ROLE_KEYWORDS = {
    ...
    "macro_risk": ["macro", "risk", "factor", "fama", "aqr", "fred", "rate", "yield", "fx", "currency", "commodity"],
...
PROVIDER_FALLBACKS = {
    ...
    "macro_risk": ["drive:ml_trading_risk_factors_csv", "drive:alpha_factor_library", "drive:alpha_factor_library/aqr", "cache:repo", "api:aqr_public_library", "api:fred", "api:yfinance"],
