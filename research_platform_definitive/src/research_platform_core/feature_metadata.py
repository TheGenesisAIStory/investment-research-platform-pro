...
FEATURE_METADATA.update(
    {
        ...
        "macro_credit_spread": FeatureMetadata("macro_credit_spread", "Credit spread proxy", "macro_context", "Lagged 21-day relative return of HYG versus TLT.", "return_21d(HYG) - return_21d(TLT), lagged one row", "Negative values indicate credit underperforming duration, a risk-off warning."),
        ...
        "macro_yield_slope": FeatureMetadata("macro_yield_slope", "Yield slope proxy", "macro_context", "Lagged 10Y minus 2Y/front-end yield proxy.", "TNX - IRX, lagged one row", "Negative values flag inversion pressure and late-cycle macro risk."),
        ...
        "macro_vix_raw": FeatureMetadata("macro_vix_raw", "Raw VIX proxy", "macro_context", "Lagged raw level of VIX implied-volatility proxy.", "VIX_t, lagged one row", "Higher values indicate higher equity-market stress."),
        ...
        "macro_vix_percentile_252d": FeatureMetadata("macro_vix_percentile_252d", "VIX percentile", "macro_context", "Lagged rolling 252-day percentile of VIX level.", "rank_pct(VIX_t over 252d), lagged one row", "Values near 1 indicate unusually elevated volatility versus the past year."),
        ...
        "macro_regime_encoded": FeatureMetadata("macro_regime_encoded", "Encoded market regime", "macro_context", "Numeric encoding of the current market regime for experimental ML tests.", "risk_on=1, recovery=0.5, risk_off=-0.5, crisis=-1, lagged one row", "Higher values indicate more supportive macro regime context."),
