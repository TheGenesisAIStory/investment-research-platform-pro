...
_PAPER_BY_CATEGORY = {
    "model_validation": "Grinold and Kahn (2000); Spearman (1904) for rank correlation",
    "portfolio": "Sharpe (1966); Grinold and Kahn (2000)",
    "risk": "Markowitz (1952); Rockafellar and Uryasev (2000)",
    "distribution": "Gen.is.IA internal distribution diagnostics",
    "implementation": "Grinold and Kahn (2000), Active Portfolio Management",
    "attribution": "Brinson, Hood and Beebower (1986)",
    "forecasting": "Hyndman and Athanasopoulos (2021), Forecasting: Principles and Practice",
...
def _complete_metric_metadata(meta: MetricMetadata) -> MetricMetadata:
    paper = meta.paper or _PAPER_BY_CATEGORY.get(meta.category, "Gen.is.IA internal metric methodology")
    return replace(
        meta,
        formula_latex=meta.formula_latex or _metric_latex_from_formula(meta.formula),
        paper=paper,
        typical_range=meta.typical_range or "strategy/model dependent",
    )
