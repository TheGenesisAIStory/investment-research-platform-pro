...
EXPANDED_MULTI_ASSET_ROWS: tuple[dict[str, Any], ...] = (
    ...
    {"symbol": "BTPI_MI", "provider_symbol": "IBTM.MI", "name": "Italy government bond ETF proxy", "asset_class": "fixed_income_etf", "region": "it", "currency": "EUR", "category": "sovereign", "exposure": "Italy BTP proxy", "priority": 2},
